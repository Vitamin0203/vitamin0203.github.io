...
var _swiperSlider = require("./vendor/swiper-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  setTimeout(function () {
    return _initAccordion.accordions.updateAccordionsHeight();
  }, 1000);
  ...
  // swiper
  (0, _swiperSlider.initTrainersSlider)();
  (0, _swiperSlider.initReviewsSlider)();
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13,"./vendor/init-accordion":16,"./vendor/init-tabs":17,"./vendor/swiper-slider":18,"./vendor/video":20}],2:[function(require,module,exports){
"use strict";
