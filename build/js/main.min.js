...
var _accordion = _interopRequireDefault(require("./vendor/accordion"));
...
function findVideos() {
  var videos = document.querySelectorAll('.gym-container__video');
  for (var i = 0; i < videos.length; i++) {
    setupVideo(videos[i]);
  }
}
function setupVideo(video) {
  var link = video.querySelector('.gym-container__video-link');
  var button = video.querySelector('.gym-container__video-button');
...
function parseMediaURL(media) {
  var regexp = /https:\/\/www\.youtube\.com\/watch\?v=([a-zA-Z0-9_-]+)/;
  var url = media.href;
...
// скрипт для табов
var tabsTriggersitems = document.querySelectorAll('.faq-wrapper__tabs-triggers__item');
tabsTriggersitems.forEach(function (item) {
  return item.addEventListener('click', function (e) {
    e.preventDefault();
    var id = e.target.getAttribute('href').replace('#', '');
    document.querySelectorAll('.faq-wrapper__tabs-triggers__item').forEach(function (child) {
      return child.classList.remove('faq-wrapper__tabs-triggers__item--activ');
    });
    document.querySelectorAll('.faq-wrapper__tabs-content__item').forEach(function (child) {
      return child.classList.remove('faq-wrapper__tabs-content__item--activ');
    });
...
new _accordion.default('#tab-1');
// eslint-disable-next-line no-new, no-undef
new _accordion.default('#tab-2');
// eslint-disable-next-line no-new, no-undef
new _accordion.default('#tab-3');
// eslint-disable-next-line no-new, no-undef
new _accordion.default('#tab-4');
...
// Найти форму
var form = document.querySelector('.feedback-form__data');

// Найти элементы ввода и метки
var nameInput = form.querySelector('input[name="name"]');
var phoneInput = form.querySelector('input[name="phone"]');
var nameLabel = form.querySelector('.form-name');
var phoneLabel = form.querySelector('.form-phone');
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13,"./vendor/accordion":15}],2:[function(require,module,exports){
"use strict";
  ...
  var Accordion = function Accordion(selectorOrElement, userOptions) {
    ...
    var core = {
      ...
      createDefinitions: function createDefinitions() {
        ...
        var allElements = onlyChildNodes ? this.container.childNodes : this.container.querySelectorAll(cn(elementClass));
